...
export type ChangesEntry = [vscode.Uri, vscode.Uri | undefined, vscode.Uri | undefined];
...
export class DiffNormalizer {
    ...
    public async normalize(request: DiffRequest): Promise<NormalizedCommandEntry[]> {
